...
class AppEEARSClient:
    ...
    def __init__(self) -> None:
        ...
        self.poll_seconds = min(configured_poll_seconds, 2.0) if self.demo_fallback else configured_poll_seconds
        self.max_wait_seconds = min(configured_max_wait_seconds, 10.0) if self.demo_fallback else configured_max_wait_seconds
